...
public class StartClass {
    ...
    static
    {
        ...
        commands.add("To add friendship type: 4; firstFriendName ; secondFriendName");
    ...
    public static void main(String[] args) {
        ...
        //вывыодится на экран информация о возможных коммандах и примерах ввода информации
    ...
    public static boolean execution (JavaContactService service)
    {
        ...
        switch(Integer.parseInt(userAnswer[0]))
        {
            case 1:
            {
                String firstName = userAnswer[1];
                String lastName = userAnswer[2];
